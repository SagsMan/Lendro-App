...
export default function LoginScreen() {
  ...
  const handleSignIn = async () => {
    ...
    try {
      ...
      setLoading(false);
      // Fallback: demo mode accepts any credentials
      if (err.message?.includes("fetch") || err.message?.includes("network") || err.message?.includes("Failed")) {
        // Server offline — demo login
  ...
  return (
    ...
    >
      ...
      >
        {/* Header gradient */}
        <LinearGradient colors={["#2D1B8E", "#1A1A2E"]} style={[styles.header, { paddingTop: insets.top + 20 }]}>
          <View style={styles.logoWrap}>
            <LinearGradient colors={["#F5A623", "#E8931A"]} style={styles.logoCircle}>
...
const styles = StyleSheet.create({
  ...
  card: { backgroundColor: "#fff", borderTopLeftRadius: 28, borderTopRightRadius: 28, marginTop: -20, flex: 1, paddingHorizontal: 24, paddingTop: 28, paddingBottom: 40 },
  ...
  eyeBtn: { padding: 6 },
  actionBtn: { marginTop: 4, borderRadius: 14, overflow: "hidden" },
  actionGradient: { height: 52, alignItems: "center", justifyContent: "center" },
  actionLabel: { fontSize: 16, fontFamily: "Inter_600SemiBold", color: "#fff" },
  ...
  terms: { fontSize: 11, fontFamily: "Inter_400Regular", color: "#9CA3AF", textAlign: "center", marginTop: 20, lineHeight: 16 },
