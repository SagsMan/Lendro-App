      ...
      <View style={styles.root}>
        <FlatList
          ...
          renderItem={({ item }) => (
            ...
            >
              <View style={[styles.slideContent, { paddingTop: insets.top + 24 }]}>

                {/* Top logo mark — shown on all slides */}
                <View style={styles.topLogoRow}>
                  <Image
                    ...
                    resizeMode="contain"
                  />
                  <Text style={styles.topLogoText}>LENDRO</Text>
                </View>

                {/* Hero area — large logo on slide 1, icon circle on slides 2-3 */}
                {item.showLogo ? (
                  <View style={styles.heroLogoWrap}>
                    <View style={[styles.heroLogoBg, { borderColor: item.accent + "50" }]}>
                      <Image
                        source={require("../assets/images/icon.png")}
